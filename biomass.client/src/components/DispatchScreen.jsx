    ...
    if (locationCosts.labourChargesEnabled) {
      if (locationCosts.labourChargeType === "Fixed") {
        ...
        if (locationCosts.labourVariableChargeType === "LabourPerMaan") {
          labourCost =
            (locationCosts.labourVariableChargeAmount || 0) * weightInMaan;
        } else {
    ...
    if (locationCosts.receivingUnloadingCostEnabled) {
      if (locationCosts.receivingChargeType === "Fixed") {
        ...
        if (locationCosts.receivingVariableChargeType === "UnloadingPerMaan") {
          unloadingCost =
            (locationCosts.receivingVariableChargeAmount || 0) * weightInMaan;
        } else {
              ...
              {locationCosts && (
                <Box>
                  <Typography
                    ...
                    gutterBottom
                  >
                    Selected: {locationCosts.locationName} (
                    {locationCosts.locationCode})
                  </Typography>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleInputChange("companyRate", e.target.value)
                    }
                    InputProps={{
                      startAdornment: (
                      ...
                      {locationCosts.dispatchLoadingChargesEnabled && (
                        <Box>
                          ...
                          {locationCosts.dispatchChargeType === "Fixed" && (
                            <Typography variant='body2'>
                              Fixed Cost: Rs{" "}
                              {locationCosts.fixedLoaderCost?.toLocaleString()}
                            </Typography>
                          )}
                          {locationCosts.dispatchChargeType === "Variable" && (
                            <Box>
                              <Typography variant='body2'>
                                Variable Type:{" "}
                                {locationCosts.variableChargeType}
                              </Typography>
                              <Typography variant='body2'>
                      ...
                      {locationCosts.labourChargesEnabled && (
                        <Box>
                          ...
                          {locationCosts.labourChargeType === "Fixed" && (
                            <Typography variant='body2'>
                              Fixed Cost: Rs{" "}
                              {locationCosts.fixedLabourCost?.toLocaleString()}
                            </Typography>
                          )}
                          {locationCosts.labourChargeType === "Variable" && (
                            <Box>
                              <Typography variant='body2'>
                                Variable Type:{" "}
                                {locationCosts.labourVariableChargeType}
                              </Typography>
                              <Typography variant='body2'>
                                Amount: Rs{" "}
                                {locationCosts.labourVariableChargeAmount}
                              </Typography>
                            </Box>
                          )}
                        </Box>
                      ...
                      {locationCosts.receivingUnloadingCostEnabled && (
                        <Box>
                          ...
                          {locationCosts.receivingChargeType === "Fixed" && (
                            <Typography variant='body2'>
                              Fixed Cost: Rs{" "}
                              {locationCosts.fixedUnloadingCost?.toLocaleString()}
                            </Typography>
                          )}
                          {locationCosts.receivingChargeType === "Variable" && (
                            <Box>
                              <Typography variant='body2'>
                                Variable Type:{" "}
                                {locationCosts.receivingVariableChargeType}
                              </Typography>
                              <Typography variant='body2'>
                                Amount: Rs{" "}
                                {locationCosts.receivingVariableChargeAmount}
                              </Typography>
                            </Box>
                          )}
                        </Box>
            ...
            <Card>
              <CardContent>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          {calculatedCosts.companyRatePerTon}
                        </TableCell>
                        <TableCell>-</TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell>
                          {calculatedCosts.companyRatePerMaan}
                        </TableCell>
                        <TableCell>-</TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow sx={{ bgcolor: "#f5f5f5" }}>
                        <TableCell>
                          <strong>Rate to Trolly Owner</strong>
                        </TableCell>
                        <TableCell>-</TableCell>
                        <TableCell>
                          <strong>
                            {calculatedCosts.breakdown.rateToTrollyOwner.toLocaleString()}
                          </strong>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell>
                          {locationCosts?.dispatchChargeType}
                        </TableCell>
                        <TableCell>
                          {calculatedCosts.loaderCost.toLocaleString()}
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell>
                          {calculatedCosts.labourCost.toLocaleString()}
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell>-</TableCell>
                        <TableCell>
                          {calculatedCosts.freightCharges.toLocaleString()}
                        </TableCell>
                      </TableRow>
                ...
                <Alert severity='info' sx={{ mb: 2 }}>
                  <Typography variant='body2'>
                    <strong>Business Logic Applied:</strong> Based on the
                    selected location configuration, the system automatically
                    calculates costs using{" "}
                    {locationCosts?.dispatchChargeType?.toLowerCase()} loader
                    charges,
                    {locationCosts?.labourChargeType?.toLowerCase()} labour
                    charges, and{" "}
                    {locationCosts?.receivingChargeType?.toLowerCase()}{" "}
                    unloading costs.
                  </Typography>
                </Alert>
              </CardContent>
