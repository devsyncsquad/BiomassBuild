  ...
  useEffect(() => {
    if (materialRateData) {
      setFormData({
        ...
        effectiveDate: materialRateData.effectiveDate
          ? new Date(materialRateData.effectiveDate).toISOString().split("T")[0]
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error.response?.data?.errors) {
        ...
        setError(
          "Error saving material rate. Please try again. Status: " +
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInputChange("companyRate", parseFloat(e.target.value))
              }
              required
              InputProps={{
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) =>
                handleInputChange("transporterRate", parseFloat(e.target.value))
              }
              required
              InputProps={{
                startAdornment: <Typography variant='body2'>Rs</Typography>,
